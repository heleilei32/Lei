...
<head>
  ...
  <link rel="stylesheet" href="/resources/css/consleCss/animate.css" type="text/css" />
  <link rel="stylesheet" href="/resources/css/font-awesome.min.css" type="text/css" />
  <link rel="stylesheet" href="/resources/css/consleCss/simple-line-icons.css" type="text/css" />
  <link rel="stylesheet" href="/resources/css/consleCss/font.css" type="text/css" />
  <link rel="stylesheet" href="/resources/css/consleCss/app.css" type="text/css" />
</head>
<body>
  <div class="app app-header-fixed" id="app">
                ...
                <ul class="nav nav-sub dk">
                  ...
                  <li>
                    <a ui-sref="access.signup">
                      <span translate="aside.nav.components.pages.SIGNUP">登出</span>
                    </a>
                  </li>
                  <li>
                    <a ui-sref="access.forgotpwd">
                      <span translate="aside.nav.components.pages.FORGOT_PASSWORD">忘记密码</span>
                    </a>
                  </li>
                  <li>
      ...
      <div class="app-content-body fade-in-up">
        <!-- COPY the content from "tpl/" -->
          <div class="hbox hbox-auto-xs hbox-auto-sm">
            <div class="col">
              <div style="background:url(/resources/img/dnf.jpg) center center; background-size:cover">
                <div class="wrapper-lg bg-white-opacity">
                  <div class="row m-t">
                    <div class="col-sm-7">
                      <a href class="thumb-lg pull-left m-r">
                        <img src="/resources/img/dnf.jpg" class="img-circle">
                      </a>
                      <div class="clear m-b">
    ...
    <div class="app-footer wrapper b-t bg-light">
      ...
      &copy; 2014 Copyright. More Templates <a href="http://www.moban520.com/" target="_blank" title="模板小站">模板小站</a> - Collect from <a href="http://www.moban520.com/" title="网页模板" target="_blank">网页模板</a>
    </div>
    <!-- / footer -->
  </div>
  <!-- jQuery -->
